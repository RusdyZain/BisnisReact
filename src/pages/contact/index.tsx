...
function kontak() {
    return (
        <div className="bg-[#252534]">
            <Header />
            <div className="bg-[#252534] max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                <div className="max-w-2xl lg:max-w-5xl mx-auto">
                    <div className="text-center">
                        <h1 className="text-3xl font-bold text-[#3282CD] sm:text-4xl ">
                            Hubungi Kami
                        </h1>
                    ...
                    <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                        ...
                        <div className="divide-y divide-gray-200 ">
                            ...
                            <div className="flex gap-x-7 py-6">
                                ...
                                <div>
                                    <h3 className="font-semibold text-[#3282CD] ">Instagram</h3>
                                    <p className="mt-1 text-sm text-white">
                                        Hubungi kami melalui Direct Message Instagram
                                    </p>
                                    <a
                                        className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-white hover:text-[#3282CD]  "
                                        href="#"
                                    >
                                        Direct Message
                                        <svg
                            ...
                            <div className=" flex gap-x-7 py-6">
                                ...
                                <div>
                                    <h3 className="font-semibold text-[#3282CD] ">Facebook</h3>
                                    <p className="mt-1 text-sm text-white">
                            ...
                            <div className=" flex gap-x-7 py-6">
                                ...
                                <div>
                                    <h3 className="font-semibold text-[#3282CD] ">WhatsApp</h3>
                                    <p className="mt-1 text-sm text-white">
                            ...
                            <div className=" flex gap-x-7 py-6">
                                ...
                                <div>
                                    <h3 className="font-semibold text-[#3282CD] ">Email</h3>
                                    <p className="mt-1 text-sm text-white">
